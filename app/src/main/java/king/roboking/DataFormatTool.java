...
public class  DataFormatTool {
    ...
    public static byte[] obtainBytes(String str){
        ...
        for(int i=0;i<dlen;i++)
        {
            ...
            if(i0==9999)
            {
                Toast.makeText(MyApplicationContext.getInstance(),"无法解析，未知字符:"+str.charAt(2*i),Toast.LENGTH_SHORT).show();
            ...
            if(i1==9999)
            {
                Toast.makeText(MyApplicationContext.getInstance(),"无法解析，未知字符:"+str.charAt(2*i+1),Toast.LENGTH_SHORT).show();
