...
import king.roboking.OnPositionChanger;
...
public class FloatWindowManager implements OnPositionChanger{
    ...
    public FloatWindowManager(Context context){
        ...
        //初始化悬浮窗
        windowManager= (WindowManager) MyApplicationContext.getInstance().getSystemService(MyApplicationContext.WINDOW_SERVICE);
